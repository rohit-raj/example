...
curl -X POST -H "Content-Type: application/json" -d @/var/lib/jenkins/jobs/example/workspace/test.json https://csp-report.com/app2/csp/_report?api_key=5d084f5b1b5144ddb260a27b2bb25b
